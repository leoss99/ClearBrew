/*	This file is taken from the Intel University Program, and can be found
	on the Linux ARM HPS at `~/tutorial_files`.
	Only the LOAD_CELL_BASE address was added, all else is unmodified.
 */
...
#define LOAD_CELL_BASE         0x00000010 // Changed 04-02 AF
