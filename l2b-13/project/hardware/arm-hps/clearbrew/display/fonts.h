...
// The video driver did not have a definition for black, so we made our own
#define video_BLACK     0x0000

/*
	A Note from the ClearBrew Team:
	
	This code was taken from ShreyansK2000/Translaite, from the following file:
		https://github.com/ShreyansK2000/Translaite/blob/master/Display/Fonts.h
	
	This file is used with minimal modification, and so we cannot take credit for this work.
 ...
 */
void write_word(int x_offset, int y_offset, const char *word, short backgroundColour, short colour, int size);
